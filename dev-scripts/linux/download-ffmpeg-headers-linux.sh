#!/bin/bash
#
# Download FFmpeg Headers for Linux
# Execute on: Linux
# Target: Linux compilation
#
...
OUTPUT_DIR="$PROJECT_ROOT/external/ffmpeg/linux"
...
# For x86/x64 Linux, little endian (AV_HAVE_BIGENDIAN=0)
...
echo
echo "You can now build for Linux without installing"
echo "FFmpeg development packages."
echo
echo "Next step:"
echo "  cmake -B build/linux -S . -DCMAKE_BUILD_TYPE=Release"
echo "  make -C build/linux -j\$(nproc)"
echo "=================================================="
